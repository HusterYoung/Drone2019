...
/**
**16位CRC算法使用说明：
**①发送数据时：在数据后空出两个字节附加CRC校验和，使用Append_CRC16_Check_Sum()附加。
**②收到数据检验数据是否正确时，使用Verify_CRC16_Check_Sum()。
**③适用于两个字节以上的校验
 */ 
...
/**
***send a message(16位CRC校验):
 */
//short dataLength = 10;
//unsigned char TxMessage[dataLength+2];
//Append_CRC16_Check_Sum(TxMessage, dataLength+2);

///**
//***verify a message(16位CRC校验）
// */
//unsigned char RxMessage[dataLength];  //接收缓冲区,dataLength为接收到的数据字节个数
//if(Verify_CRC16_Check_Sum(RxMessage, dataLength) == 1)
//{
//	//解码
//}
